...
const WhatsAppButton = () => {
  ...
  return (
    <>
      <button
        onClick={handleClick}
        className="fixed bottom-6 left-6 z-50 bg-[#25D366] p-3 rounded-full shadow-lg hover:bg-[#128C7E] transition-all duration-300 group"
      ...
      >
        ...
        <span className="absolute left-16 bg-white text-gray-800 px-4 py-2 rounded-lg shadow-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
          Contactez-nous
        </span>
      </button>
